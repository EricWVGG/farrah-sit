...
export type Project = {
  ...
  _rev: string
  metadata: Metadata
  projectType: 'lighting' | 'sculpture' | 'collaboration'
  copy: Array<{
    children?: Array<{
      marks?: Array<string>
      text?: string
...
// Query: *[(_type == 'page' || _type == 'projectV2') && metadata.slug.current == $slug][0]{    metadata {      ...,      poster {  ...,  asset-> {    metadata {      lqip,      blurHash,      dimensions    },    url  }}    }  }
